/*ident	"@(#)C++env:incl-master/proto-headers/sys/syslog.h	1.1" */

#ifndef __SYSLOG_H
#define __SYSLOG_H

#define openlog ______openlog
#define syslog ______syslog
#define setlogmask ______setlogmask
#define closelog ______closelog

/*	@(#)syslog.h 1.4 88/02/08 SMI; from UCB 7.1 6/5/86	*/
