/*ident	"@(#)C++env:incl-master/proto-headers/sys/msg.h	1.1" */
...
#define msgctl ______msgctl
#define msgget ______msgget
#define msgrcv ______msgrcv
#define msgsnd ______msgsnd

/*	@(#)msg.h 1.11 88/02/08 SMI;	from S5R2 6.1 */
