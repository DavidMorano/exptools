 ...
 * 77 ints in 3.x.  A pad of this size difference is added to struct Bsdcore.
 */
 ...
 * c_len field.  When struct Bsdcore is changed, c_fpstatus
...
struct Bsdcore {
	...
	int	c_len;			/* Sizeof (struct Bsdcore) */
