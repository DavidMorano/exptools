...
friend  Prof_obj(T) objectify(Procedure(T)& p);
	Procedure(T)&	f;
		Prof_obj(T)(Procedure(T)& p) : f(p) {}
public:
	void	operator()(T*);
};
inline Prof_obj(T)
objectify(Procedure(T)& p)
{
	return Prof_obj(T)(p);
}
...
friend  Prof_Tran_obj(T) operator*(Procedure(T)& p, Tran_obj(T)& q);
	Procedure(T)&	proc;
	Tran_obj(T)&	tran;
		Prof_Tran_obj(T)(Procedure(T)& p, Tran_obj(T)& q) :
				proc(p), tran(q) {}
public:
	void	operator()(T*);
};
inline Prof_Tran_obj(T)
operator*(Procedure(T)& p, Tran_obj(T)& q)
{
...
friend  Prof_Pred_obj(T) operator*(Procedure(T)& p, Pred_obj(T)& q);
	Procedure(T)&	proc;
	Pred_obj(T)&	pred;
		Prof_Pred_obj(T)(Procedure(T)& p, Pred_obj(T)& q) :
				proc(p), pred(q) {}
public:
	void	operator()(T*);
};
inline Prof_Pred_obj(T)
operator*(Procedure(T)& p, Pred_obj(T)& q)
{
