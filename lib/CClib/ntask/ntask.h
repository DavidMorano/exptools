...
/* Sun mods @(#)task.h 1.2 88/07/03 SMI */
/* Ported to V2.0 by GRT 89/09/28 */
/* Re-ported to V2.1 by GRT 90/09/05 */
/**************************************************************************
...
private:
	...
	int	init_stack(int*,int*); /* initialize child stack */
...
#ifdef sparc
	// On sparc, these two registers (%fp and %i7) must be saved
	// *during* swap.  It's least confusing (to me) to put them here.
	int*	t_save_i6;
	int*	t_save_i7;
#endif
