...
(defconst emacs-version "19.22.1" "\
...
;; modified-sft, local modification, referenced in startup.el
;;
(defconst emacs-distribution-type 
  (cond ((getenv "GNU_DISTTYPE")) (t "Exptools")))
