...
struct qprojection {
	...
	unsigned char flags;	/* flags about attribute sorting/projection */
 ...
 */
#define QP_NUMERIC	0x01	/* do numeric comparisons */
#define QP_STRING	0x02	/* do normal string comparisons */
#define QP_CASELESS	0x03	/* do caseless string comparisons */
#define QP_DATE		0x04	/* do date comparison */

#define QP_SORTMASK	0x07	/* mask for getting type of sort above */

#define QP_DESCENDING	0x08	/* sort in descending order, not ascending */
#define QP_RMBLANKS	0x10	/* remove blanks at start of attr value */
#define QP_NODISPLAY	0x20	/* don't display the attribute, only sort it */
#define QP_SORT		0x40	/* sort on this attribute */
